...
import {
  setSuccess,
  setError,
} from "@/app/store/specialEqSlice/basket/basketSlice";
import { useEffect, useState } from "react";
import { AlertComponent } from "@/components/alerts/alert";
import { createBasketAsync } from "@/app/store/specialEqSlice/basket/basketThunks";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className=" space-y-5 ">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-full flex flex-col">
              <FormLabel>Самоход\Авто</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Выберите самоход\авто" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="Самоход">Самоход</SelectItem>
                  <SelectItem value="На авто">На авто</SelectItem>
                </SelectContent>
              </Select>
              <FormMessage />
            </FormItem>
