...
import { getAllProposals } from "@/app/store/slice/proposalSlice";
import NewCompanyModal from "../companies/newCompany/NewCompanyModal";
...
const ProposalsTable = () => {
  ...
  const data = useSelector((state: any) => state.proposal.proposals);
