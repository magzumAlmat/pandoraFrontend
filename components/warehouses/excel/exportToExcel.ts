...
export const onExport = (data, dateRange) => {
  ...
  worksheet.columns = [
    ...
    { header: "Предоплата", key: "prepayment", width: 50 },
  ...
  const title = `Pandora Logistics CRM Самоход Спецтехника - Склад ${filteredData[0].warehouse_statuses[0].warehouse.warehouse_name} - ${formattedDateRange}`;
